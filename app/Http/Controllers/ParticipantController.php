...
class ParticipantController extends Controller
{
     ...
     * @return void
     */
    // harus minimal protected agar kompatibel dengan definisi di base Controller
    protected function clearDashboardCaches(?int $regionId = null): void
    {
        ...
        // Clear regional dashboard cache for the specific region/user
        if ($regionId) {
            // cache key untuk user daerah memakai user id (lihat DashboardController)
            \Illuminate\Support\Facades\Cache::forget('daerah_dashboard_' . Auth::id());
            // jaga-jaga kalau ada varian lain pakai region id
